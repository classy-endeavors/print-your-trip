...
const Stepper: React.FC<StepperProps> = ({
  ...
  return (
    <div className="flex h-20 w-full flex-col items-start px-5">
      <div className="flex w-full items-center rounded-full bg-alice-blue px-1 py-1">
        {steps.map((step, idx) => (
          <React.Fragment key={step}>
                ...
                className={`flex h-8 w-8 items-center justify-center rounded-full border-2 transition-colors duration-300 ${
                  idx < currentStep
                    ...
                    : idx === currentStep
                      ...
                      : "border-[#E2E6D9] bg-[#F3F5ED] text-black"
                } `}
              >
            ...
            {idx < steps.length - 1 && (
              <div className="relative flex h-1 flex-1 items-center">
                {/* Track */}
                <div className="absolute top-0 left-0 h-1 w-full overflow-hidden bg-[#E2E6D9]" />
                {/* Animated fill */}
                <motion.div
                  ...
                  animate={{
                    ...
                    opacity: idx < currentStep || idx === currentStep ? 1 : 0.5,
                  }}
                  style={{ zIndex: 1 }}
                />
              </div>
